...
(function() {
    ...
    encodeKeyValue: function (k, v, opts) {
      ...
      return function() {
        return f.cat(
          ...
          [codec.encodeObject(v, outer.clientOpts)]       // value
        );
      }
    },
  ...
  var DecodeMixin = (function() {
    ...
    return {
      ...
      decodeValue: function(clientOpts) {
        return function(promise, header, bytebuf) {
          return decodeObject(promise, header, bytebuf, f.actions([codec.decodeObject(clientOpts)], codec.lastDecoded));
        }
      },
